"""
Django settings for GeneralAdmin project.
...
SECRET_KEY = 'r(myy57oetm_*-oxdfnu^0lf%akkocs)n1yywu)-er2y^hvtnd'
...
ROOT_URLCONF = 'GeneralAdmin.urls'
...
WSGI_APPLICATION = 'GeneralAdmin.wsgi.application'
...
MAIL_USER= "573293679@qq.com"  # 用户名
MAIL_PASS = "jciuhvejgflobdia"  # 口令
SENDER = '573293679@qq.com'
RECEIVERS = ['573293679@qq.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
